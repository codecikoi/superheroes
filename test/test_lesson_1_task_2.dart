...
void runTestLesson1Task2() {
  testWidgets('module2', (WidgetTester tester) async {
    ...
    final actionButtonFinder = findTypeByTextOnlyInParentType(
        ActionButton, "Next State".toUpperCase(), Stack);
    expect(
      actionButtonFinder,
      findsOneWidget,
    ...
    final containerFinder = findTypeByTextOnlyInParentType(
        Container, "Next State".toUpperCase(), ActionButton);
    ...
    final gestureDetectorFinder = findTypeByTextOnlyInParentType(
        GestureDetector, "Next State".toUpperCase(), ActionButton);
    ...
    final GestureDetector gestureDetector =
        tester.firstWidget(gestureDetectorFinder);
