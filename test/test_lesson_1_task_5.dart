...
//       );
//
//       final Text yourFavoritesText =
//           tester.firstWidget(yourFavoritesTextFinder);
//
//       checkTextProperties(
...
//       );
//
//       final columnFinder = findTypeByTextOnlyInParentType(
//           Column, "Your favorites", MainPageStateWidget);
//
//       expect(
//         columnFinder,
//         findsOneWidget,
...
//         findsOneWidget,
//         reason:
//             "Text with text 'Your favorites' should be wrapped with Padding",
//       );
//
...
//       );
//
//       final batmanCardFinder = findTypeByTextOnlyInParentType(
//           SuperheroCard, "BATMAN", MainPageStateWidget);
//
//       expect(
//         batmanCardFinder,
//         findsOneWidget,
...
//         "Batman",
//         reason:
//             "SuperheroCard with Batman should have 'Batman' as a name parameter",
//       );
//       expect(
//         batmanCard.realName,
//         "Bruce Wayne",
//         reason:
//             "SuperheroCard with Batman should have 'Bruce Wayne' as a realName parameter",
//       );
//       final batmanUrl =
...
//         batmanUrl,
//         reason:
//             "SuperheroCard with Batman should have '$batmanUrl' as an imageUrl parameter",
//       );
//
...
//       );
//
//       final Padding paddingOfBatmanCardText =
//           tester.widget(paddingOfBatmanCardTextFinder);
//       checkEdgeInsetParam(
//         widgetName: "Padding",
...
//       // --------------?
//
//       final ironmanCardFinder = findTypeByTextOnlyInParentType(
//           SuperheroCard, "IRONMAN", MainPageStateWidget);
//
//       expect(
//         ironmanCardFinder,
//         findsOneWidget,
...
//         "Ironman",
//         reason:
//             "SuperheroCard with Batman should have 'Ironman' as a name parameter",
//       );
//       expect(
//         ironmanCard.realName,
//         "Tony Stark",
//         reason:
//             "SuperheroCard with Batman should have 'Tony Stark' as a realName parameter",
//       );
//       final ironmanUrl =
...
//         ironmanUrl,
//         reason:
//             "SuperheroCard with Batman should have '$ironmanUrl' as an imageUrl parameter",
//       );
//
...
//       );
//
//       final Padding paddingOfIronmanCardText =
//           tester.widget(paddingOfIronmanCardTextFinder);
//       checkEdgeInsetParam(
//         widgetName: "Padding",
...
//       );
//
//       final Container topLevelSuperheroCardContainer =
//           tester.widget(containerInsideSuperheroCard);
//       checkContainerColor(
...
//       );
//       final SizedBox sizedBoxInsideSuperheroCard =
//           superheroCardRow.children[1] as SizedBox;
//       expect(
...
//         isInstanceOf<Column>(),
//         reason:
//             "Third child in Row inside SuperheroCard should be a Expanded with Column as a child",
//       );
//
//       final Column columnInsideSuperheroCard =
//           (superheroCardRow.children[2] as Expanded).child as Column;
//       expect(
...
//         6,
//         reason:
//             "There should be 6 widgets inside Column. Widget with text 'Your favorites',"
...
//         20,
//         reason:
//             "Top SizedBox between title and first SuperheroCard should have 20 height",
//       );
//
//       expect(
//         column.children[4],
