...
void runTestLesson1Task3() {
  testWidgets('module3', (WidgetTester tester) async {
    ...
    final alignFinder = findTypeByTextOnlyInParentType(
        Align, "Enter at least 3 symbols", Stack);
    expect(
      alignFinder,
      findsOneWidget,
      reason:
          "There should be an Align inside Stack with text inside 'Enter at least 3 symbols'",
    );
    ...
    final paddingFinder = findTypeByTextOnlyInParentType(
        Padding, "Enter at least 3 symbols", Align);
    expect(
      paddingFinder,
      findsOneWidget,
